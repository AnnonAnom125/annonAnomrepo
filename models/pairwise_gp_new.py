...
class PairwiseGP(Model, GP, FantasizeMixin):
    ...
    def __init__(
        ...
        type_likelihood: Optional[bool] = True,
        **kwargs,
    ) -> None:
        r"""
        Args:
        ...
        self.likelihood = (
            PairwiseProbitLikelihood() if likelihood is None and type_likelihood == False else PairwiseLogitLikelihood() if likelihood is None and type_likelihood == True else likelihood
        )
