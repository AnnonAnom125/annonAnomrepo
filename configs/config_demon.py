...
class DEMON_SDXL:
    ...
    beta: float =0.1,
    tau:str ="adaptive",
    K: int = 4,             # Number of candidate samples (was action_num)
    demon_type: str ="tanh",# Weighting method (was weighting)
    r_of_c:str ="baseline",
    c_steps: int =20,
    ode_after: float =0.11,
    guidance_scale: int =2,
    save_pils: bool =False,
    
    reward_type: str = "aesthetic" # aesthetic, picscore
...
@dataclass
class DEMON_SDXL_promptset(DEMON_SDXL):
