...
for category in $CATEGORY; do
    ...
    python -u scripts/promptset/promptset_BObench/baselines/DEMON_sdxl.py \
    --output_path "$RESULT_PATH" --mode $MODE --obj_name "$OBJECTIVES" --num_samples_per_prompt 3 --K $T\
