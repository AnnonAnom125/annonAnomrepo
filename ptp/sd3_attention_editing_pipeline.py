...
class SD3AttentionEditingPipeline(StableDiffusion3Pipeline):
    r"""
    Args:
    This model inherits from [`StableDiffusion3Pipeline`]. Check the superclass documentation for the generic methods the library implements for
