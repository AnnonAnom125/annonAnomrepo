...
from scripts.promptset.promptset_BObench.baselines.utils.demon.src.api import demon_sampling, get_init_latent, odeint
from scripts.promptset.promptset_BObench.baselines.utils.demon.src.utils import from_latent_to_pil
...
class DemonGenerater(ABC):
    ...
    def generate(self, prompt, ode=False):
        ...
        self.log_dir = os.path.join(self.experiment_directory)
        ...
        if not ode:
            ...
            # )
        return pil, from_latent_to_pil(initial_latent)
